...
import com.hengyun.dao.notice.mysql.JobTaskDao;
import com.hengyun.domain.notice.ScheduleJob;

/**
* @author bob E-mail:panbaoan@thealth.cn
* @version 创建时间：2016年3月23日 下午2:59:20
* 计划任务管理
*/
...
public class JobTaskService {
	...
	public void addTask(ScheduleJob job) {
		...
		jobTaskDao.insertSelective(job);
	}
	...
	public ScheduleJob getTaskById(Long jobId) {
		return jobTaskDao.selectByPrimaryKey(jobId);
	}
	...
	public void changeStatus(Long jobId, String cmd) throws SchedulerException {
		...
		jobTaskDao.updateByPrimaryKeySelective(job);
	}
	...
	public void init() throws Exception {
		...
		// 这里获取任务信息数据
		List<ScheduleJob> jobList = jobTaskDao.getAll();

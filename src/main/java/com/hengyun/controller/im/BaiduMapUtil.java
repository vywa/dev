...
public class BaiduMapUtil {  
    ...
    public static UserLocation convertCoord(String lng, String lat) {  
        ...
        try {  
            ...
            String asB64 = Base64.getEncoder().encodeToString(jsonObject.getString("x").getBytes("utf-8"));  
            String asB642 = Base64.getEncoder().encodeToString(jsonObject.getString("y").getBytes("utf-8"));  
            location.setBd09Lng(asB64);  
            location.setBd09Lat(asB642);  
        } catch (Exception e) {  
            location = null;  
            e.printStackTrace();  
        }  

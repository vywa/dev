...
* @version 创建时间：2016年7月6日 下午4:20:09
* 类说明
*/
public class MyMessageHandler implements IMessageHandler{
	...
	public String invoke(String inputXml) throws WeixinException {
        ...
        try {
            ...
            //获取普通消息处理工具类
            INormalMessageHandler normalMsgHandler = MyHandlerFactory.getNormalMessageHandler();
            if (msgType.equals(MsgType.Text.toString())) {
                ...
                //获取消息处理工具类
                IEventMessageHandler eventMsgHandler = MyHandlerFactory.getEventMessageHandler();
                //自定义菜单事件
